 ...
 * Aws3\ResultInterface and Aws3\Exception\AwsException objects.
 */
class MockHandler implements \Countable
{
    ...
    /**
     * The passed in value must be an array of {@see Aws3\ResultInterface} or
    ...
    public function append()
    {
        foreach (func_get_args() as $value) {
            if ($value instanceof ResultInterface
                ...
                throw new \InvalidArgumentException('Expected an Aws3\ResultInterface or Aws3\Exception\AwsException.');
            }
        }
    }
