...
interface S3ClientInterface extends AwsClientInterface
{
     ...
     * use the {@see \Aws3\S3\S3Client::createPresignedRequest} method and get
     ...
     * @param array  $options Aws3\S3\BatchDelete options array.
     *
     * @see Aws3\S3\S3Client::listObjects
     ...
     *
     * @see Aws3\S3\MultipartUploader for more info about multipart uploads.
     ...
     * @param array  $options       Options used to configure the upload process.
     *
     * @see Aws3\S3\MultipartCopy for more info about multipart uploads.
     ...
     * @param array  $options   Options available in Aws3\S3\Transfer::__construct
     *
     * @see Aws3\S3\Transfer for more options and customization
     */
