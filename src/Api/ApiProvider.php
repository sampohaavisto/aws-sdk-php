...
use Aws3\Exception\UnresolvedApiException;
 ...
 * {@see Aws3\Exception\UnresolvedApiException}.
 *
 ...
 * {@see Aws3\or_chain}. This method accepts providers as arguments and
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \Aws3\manifest());
    }
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \Aws3\load_compiled_json($path);
